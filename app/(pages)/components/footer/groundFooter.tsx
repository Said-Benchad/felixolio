...
const GroundFooter = () => {
  return (
    <div className="relative h-full min-h-screen w-full bg-white text-black">
      <div className="absolute bottom-0 h-full w-screen">
        <CrowdCanvas src="/assets/peeps/all-peeps.png" rows={15} cols={7} />
      </div>
    </div>
  );
};

export { CrowdCanvas, GroundFooter };
